        ...
        {!isMobile && (
          <>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4, flex: 1, justifyContent: "flex-end" }}>
              <NavTextLink href="https://caleo-app-ochre.vercel.app/login" label="Iniciar sesión" />
              <NavTextLink href="https://caleo-app-ochre.vercel.app/register" label="Registrarse" />
            </div>
          </>
        )}
      ...
      <AnimatePresence>
        {menuOpen && isMobile && (
          ...
          >
            ...
            >
              <Link href="https://caleo-app-ochre.vercel.app/login" onClick={() => setMenuOpen(false)}
                style={{ fontSize: "0.85rem", color: "#3D2B1F", fontFamily: "system-ui", fontWeight: 600, textDecoration: "none", padding: "10px 16px" }}
              >
                Iniciar sesión
              </Link>
              <Link href="https://caleo-app-ochre.vercel.app/register" onClick={() => setMenuOpen(false)}
